<html lang="en">
	...
	<body ng-app="namoradosApp">
		<header class="ludovica-header">
			<div class="ludovica-logo"></div>
		</header>	
	
		<div class="dia-namorados" ng-controller="namoradosController">
			...
			<div class="main-container cold-md-10 col-xs-12">				
				<div class="publicidade col-md-3 col-lg-3 col-xs-12 hidden-xs hidden-md">
					...
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25743;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_cafes"></script>
					</div>
				</div>
				...
				<div class="publicidade-arroba col-md-3 col-lg-3 col-xs-12 hidden-md hidden-xl hidden-lg">
					<h1>Publicidade</h1>
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25744;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_cafes"></script>
					</div>
				</div>
			...
			<div class="titulo col-md-12 col-xs-12"><div class="espacos-svg"></div></div>
				...
				<div class="main-container cold-md-10 col-xs-12">									
					...
					<div class="publicidade-arroba col-md-3 col-lg-3 col-xs-12 hidden-md hidden-xl hidden-lg">
						<h1>Publicidade</h1>
						<div class="publicidade-content">
							<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25744;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_espaco_cultura"></script>
						</div>
					</div>
					...
					<div class="publicidade col-md-3 col-lg-3 col-xs-12 hidden-xs hidden-md">
						<h1>Publicidade</h1>
						<div class="publicidade-content">
							<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25743;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_espaco_cultura"></script>
						</div>
					</div>
				</div>				
		</section>	
		...
		<section class="restaurante" ng-controller="restauranteController">				
			...
			<div class="main-container cold-md-10 col-xs-12">				
				<div class="publicidade col-md-3 col-lg-3 col-xs-12 hidden-xs hidden-md">
					<h1>Publicidade</h1>
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25743;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_restaurante"></script>
					</div>
				</div>
				...
				<div class="publicidade-arroba col-md-3 col-lg-3 col-xs-12 hidden-md hidden-xl hidden-lg">
					<h1>Publicidade</h1>
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25744;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_restaurante"></script>
					</div>
				</div>
		...
		<section class="bares" ng-controller="baresController">				
			...
			<div class="main-container cold-md-10 col-xs-12">				
				...
				<div class="list-container col-md-4 col-lg-3 col-xs-12">
					<div class="item-list col-md-12 col-xs-12" ng-repeat="item in bares | limitTo:10:0">
						<div class="checkbox col-md-2 col-xs-2" ng-class="{selecionado: item.selecionado}" ng-click="selecionaItem($index)"><span class="glyphicon glyphicon-heart"></span></div>
						<div class="name col-md-8 col-xs-9">{{item.nome}}</div>
						<div class="info col-md-2 col-xs-2" ng-click="showCardFunction(true, item.nome)" ng-show="{{item.info}}"></div>
					</div>
				...
				<div class="publicidade-arroba col-md-3 col-lg-3 col-xs-12 hidden-md hidden-xl hidden-lg">
					<h1>Publicidade</h1>
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25744;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_bares"></script>
					</div>
				</div>
						
				<div class="list-container col-md-4 col-lg-3 col-xs-12">
					<div class="item-list col-md-12 col-xs-12" ng-repeat="item in bares | limitTo:10:10">
						<div class="checkbox col-md-2 col-xs-2" ng-class="{selecionado: item.selecionado}" ng-click="selecionaItem($index+10)"><span class="glyphicon glyphicon-heart"></span></div>
						<div class="name col-md-8 col-xs-9">{{item.nome}}</div>
						<div class="info col-md-2 col-xs-2" ng-click="showCardFunction(true, item.nome)" ng-show="{{item.info}}"></div>
					</div>
				...
				<div class="publicidade col-md-3 col-lg-3 col-xs-12 hidden-xs hidden-md">
					<h1>Publicidade</h1>
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25743;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_bares"></script>
					</div>
				</div>
			</div>				
		</section>	
		...
		<section class="noite" ng-controller="noiteController">				
			...
			<div class="main-container cold-md-10 col-xs-12">				
				<div class="publicidade col-md-3 col-lg-3 col-xs-12 hidden-xs hidden-md">
					<h1>Publicidade</h1>
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25743;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_noite"></script>
					</div>
				</div>
				...
				<div class="publicidade-arroba col-md-3 col-lg-3 col-xs-12 hidden-md hidden-xl hidden-lg">
					<h1>Publicidade</h1>
					<div class="publicidade-content">
						<script type="text/javascript" src="http://eas21.emediate.eu/eas?cu=25744;cre=mu;js=y;pageviewid=;target=_blank;EASTwordTarget=ludovica_noite"></script>
					</div>
				</div>
		...
		<div class="compatilhar-popup ng-hide" ng-show="showCompartilhar">
			<div class="compartilhar-card">
				...
				<div class="left-column col-md-3 col-xs-12">
					<div class="frase-resultado col-xs-8 col-md-12"><span>Esses <strong>{{qntdSelecionada}}</strong> programas imperdíveis de Goiânia para se curtir juntinho.</span></div>
					<div class="legenda">
						<div class="cafe col-md-12 col-xs-12"><div class="circle"></div><h1>Café - {{calculo[0].valor}}%</h1></div>
						<div class="espacos col-md-12 col-xs-12"><div class="circle"></div><h1>Espaços & Cultura - {{calculo[1].valor}}%</h1></div>
