...
function desenharGrafico(cafe, espaco, restaurante, bares, noite){
	var browserStats = [
	    {value: cafe, color: '#EBD462'},
	    {value: espaco, color: '#99C3B9'},
	    {value: restaurante, color: '#E66F5B'},
	    {value: bares, color: '#EDEEDD'},
	    {value: noite, color: '#9C47BF'},
	 ];
